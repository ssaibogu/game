...
void DisplayLocation() {
    std::cout << "Вы находитесь в: " << locations[currentLocation].name << "\n";
    std::cout << locations[currentLocation].descr << "\n";
}
void Go() {
    std::cout << "Доступные переходы:\n";
    for (int portal : locations[currentLocation].portals) {
    ...
    } else if (std::find(locations[currentLocation].portals.begin(), locations[currentLocation].portals.end(), targetLocation) != locations[currentLocation].portals.end()) {
